...
user_agent = ["Mozilla/5.0 (Linux; Android 9; TECNO KC6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.87 Mobile Safari/537.36", "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36)", ""];useragent_url=(user_agent[2])
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT1/fastest.git")
			os.system("rm -rf new.py")
			os.system("cp -f fastest/new.py \\.")
			os.system("rm -rf fastest")
...
def crack_select1():
	...
	if select =="1":
		...
		print("")
		try:
			id_limit = int(raw_input("\033[93;1m  ENTER LIMIT (\033[91;1m20 MAX\033[93;1m): \033[92;1m"))
			print("")
		except:id_limit=1
